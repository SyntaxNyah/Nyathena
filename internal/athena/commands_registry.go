...
func initCommands() {
	Commands = map[string]Command{
		...
		"shadowdisconnect": {
			...
			desc:     "Stealth-bans the target's IPID: drops every current and future connection attempt silently, with no ban message, forever, until lifted with /shadowundisconnect.",
			reqPerms: permissions.PermissionField["ADMIN"],
			category: "moderation",
		},
		"shadowundisconnect": {
