...
// commandRegex matches valid command names (e.g., /join, /join-tournament, /area_kick, /51), case-insensitively.
var commandRegex = regexp.MustCompile(`(?i)^/[a-z0-9_]+(-[a-z0-9_]+)*`)
