...
func initCommands() {
	Commands = map[string]Command{
		...
		"megamaso": {
			handler:  cmdMegamaso,
			minArgs:  0,
			usage:    "Usage: /megamaso",
			desc:     "Self-applied chaos: rolls a random punishment for 10 minutes. Each repeat ADDS another random punishment to the stack instead of replacing it.",
			reqPerms: permissions.PermissionField["NONE"],
			category: "punishment",
		},
		"sfxcurse": {
